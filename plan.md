...
```
ƒ"oƒ"?ƒ"? app/
ƒ",   ƒ"oƒ"?ƒ"? layout.tsx (root layout with gradient background)
ƒ",   ƒ"oƒ"?ƒ"? page.tsx (home page)
ƒ",   ƒ""ƒ"?ƒ"? globals.css (global styles, gradients, animations)
ƒ"oƒ"?ƒ"? components/
ƒ",   ƒ"oƒ"?ƒ"? Hero.tsx (full-width video background hero)
ƒ",   ƒ"oƒ"?ƒ"? About.tsx (two-column layout with animations)
ƒ",   ƒ"oƒ"?ƒ"? Services.tsx (animated service cards)
ƒ",   ƒ"oƒ"?ƒ"? Gallery.tsx (video/image showcase with parallax)
ƒ",   ƒ"oƒ"?ƒ"? Contact.tsx (minimal form with gradient accents)
ƒ",   ƒ"oƒ"?ƒ"? Footer.tsx (ultra-simple footer)
ƒ",   ƒ"oƒ"?ƒ"? Navigation.tsx (smooth scroll navigation)
ƒ",   ƒ""ƒ"?ƒ"? VideoBackground.tsx (reusable video component)
ƒ"oƒ"?ƒ"? public/
ƒ",   ƒ""ƒ"?ƒ"? [4 existing video files]
ƒ""ƒ"?ƒ"? package.json
```
...
- Light gradient background (white ƒ+' soft pastel)
...
## Animation Strategy
- **Text Reveals**: Framer Motion `initial={{ opacity: 0, y: 20 }}` ƒ+' `animate={{ opacity: 1, y: 0 }}`
